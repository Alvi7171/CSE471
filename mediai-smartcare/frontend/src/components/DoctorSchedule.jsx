...
const DoctorSchedule = () => {
  ...
  const fetchDoctorSchedule = async (doctorId) => {
    ...
    try {
      ...
      setNewSchedule({ ...newSchedule, doctorId: doctorId });
  ...
  const fetchDoctorAppointments = async (doctorId) => {
    try {
      const response = await fetch(`http://localhost:1355/api/appointments/doctor/${doctorId}`);
                    ...
                    <div className="space-y-3 max-h-96 overflow-y-auto">
                      {appointments.map((apt) => (
                        ...
                        >
                          ...
                          <p className="text-sm text-gray-700 mb-1">
                            <strong>🕐 Time:</strong> {apt.appointment_time.slice(0, 5)}
                          </p>
                          <p className="text-sm text-gray-700 mb-1">
                      ...
                      {schedules.map((schedule) => (
                        ...
                        >
                          ...
                          <p className="text-sm text-gray-700">
                            <strong>Time:</strong> {schedule.start_time.slice(0, 5)}{" "}
                            - {schedule.end_time.slice(0, 5)}
                          </p>
                          <p className="text-sm text-gray-700">
                            <strong>Slot Duration:</strong> {schedule.slot_duration}{" "}
                            minutes
                          </p>
                          <p className="text-sm">
                            <span
